(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bill-bill-wait-bill-wait-module"], {
    /***/
    "./src/app/bill/bill-wait/bill-wait-routing.module.ts":
    /*!************************************************************!*\
      !*** ./src/app/bill/bill-wait/bill-wait-routing.module.ts ***!
      \************************************************************/

    /*! exports provided: BillWaitPageRoutingModule */

    /***/
    function srcAppBillBillWaitBillWaitRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BillWaitPageRoutingModule", function () {
        return BillWaitPageRoutingModule;
      });
      /* harmony import */
      ...
      var _bill_wait_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./bill-wait.page */
      "./src/app/bill/bill-wait/bill-wait.page.ts");

      var routes = [{
        path: '',
        component: _bill_wait_page__WEBPACK_IMPORTED_MODULE_3__["BillWaitPage"]
      }];

      var BillWaitPageRoutingModule = function BillWaitPageRoutingModule() {
        _classCallCheck(this, BillWaitPageRoutingModule);
      };

      BillWaitPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    "./src/app/bill/bill-wait/bill-wait.module.ts":
    /*!****************************************************!*\
      !*** ./src/app/bill/bill-wait/bill-wait.module.ts ***!
      \****************************************************/

    /*! exports provided: BillWaitPageModule */

    /***/
    function srcAppBillBillWaitBillWaitModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BillWaitPageModule", function () {
        return BillWaitPageModule;
      });
      /* harmony import */
      ...
      var _bill_wait_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./bill-wait-routing.module */
      "./src/app/bill/bill-wait/bill-wait-routing.module.ts");
      /* harmony import */


      var _bill_wait_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./bill-wait.page */
      "./src/app/bill/bill-wait/bill-wait.page.ts");
      /* harmony import */


      var src_app_share_no_data_no_data_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/share/no-data/no-data.component */
      "./src/app/share/no-data/no-data.component.ts");

      var BillWaitPageModule = function BillWaitPageModule() {
        _classCallCheck(this, BillWaitPageModule);
      };

      BillWaitPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _bill_wait_routing_module__WEBPACK_IMPORTED_MODULE_5__["BillWaitPageRoutingModule"]],
        declarations: [_bill_wait_page__WEBPACK_IMPORTED_MODULE_6__["BillWaitPage"], src_app_share_no_data_no_data_component__WEBPACK_IMPORTED_MODULE_7__["NoDataComponent"]]
      })], BillWaitPageModule);
      /***/
    },
...
//# sourceMappingURL=bill-bill-wait-bill-wait-module-es5.js.map