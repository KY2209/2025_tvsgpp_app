(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bill-bill-detail-bill-detail-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppBillBillDetailBillDetailPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppBillBillDetailBillDetailRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppBillBillDetailBillDetailModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppBillBillDetailBillDetailPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppBillBillDetailBillDetailPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_donvi_donvi_index_donvi_index_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/donvi/donvi-index/donvi-index.page */
      "./src/app/donvi/donvi-index/donvi-index.page.ts");
      /* harmony import */


      var src_app_function_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/function.service */
      "./src/app/function.service.ts");
      /* harmony import */


      var src_app_kho_kho_index_kho_index_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/kho/kho-index/kho-index.page */
      "./src/app/kho/kho-index/kho-index.page.ts");
      /* harmony import */


      var src_app_service_AlertService__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var src_app_vattu_vattu_index_vattu_index_page__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      ...
      var BillDetailPage = /*#__PURE__*/function () {
        function BillDetailPage(ToastService, FunctionService, router, toastController, modalController, XuatkhoService, AlertService, navController, LoadingService, route, printer, currencyPipe, KhoService, cdr, UnitService, VattuService) {
          var _this = this;
        ...
        _createClass(BillDetailPage, [{
          ...
          value: function getLoaiCT() {
            ...
            this.FunctionService.getLoaiCT().subscribe(function (response) {
              for (var i = 0; i < response.length; i++) {
                if (response[i].LoaiCTID == _this2.sendItem.LoaiCTID) {
                  _this2.banggia = response[i].BangGia;
                  _this2.loainx = response[i].LoaiNX;
                  break;
                }
              }
          ...
          value: function handleRemove(item, index) {
            ...
            this.AlertService.presentAlert("B\u1EA1n c\xF3 ch\u1EAFc mu\u1ED1n x\xF3a m\u1EB7t h\xE0ng \"".concat(item._TenVT, "\"?")).then(function (res) {
              if (res == 'true') {
                // console.log('eeee');
                _this10.displayChiTietHang.splice(index, 1);

                _this10.sendItem.ChiTietHang.splice(index, 1);

                _this10.countMoney(_this10.sendItem); // this.countMoney(this.displayChiTietHang);
          ...
          value: function createImport() {
            ...
            this.XuatkhoService.createXuatHang(this.sendItem).subscribe(function (response) {
              if (response.code == 0) {
                _this12.ToastService.successToast(response.message); // this.resetItem();
          ...
          value: function openPrint() {
            ...
            this.printer.isAvailable().then(function (onsuccess) {
              ...
              _this14.printer.print(divContent, options).then(function (value) {
          ...
          value: function openBack() {
            console.log('aaaaa'); // var item = {
            //   "DienGiai": this.DienGiai,
            //   "LoaiCTID": this.LoaiCTID
            // }

            this.navController.navigateBack(['bill-list'], {// queryParams: item
      ...
      BillDetailPage.ctorParameters = function () {
        return [{
      ...
      BillDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-bill-detail',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./bill-detail.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/bill/bill-detail/bill-detail.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./bill-detail.page.scss */
        "./src/app/bill/bill-detail/bill-detail.page.scss"))["default"]]
      })], BillDetailPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=bill-bill-detail-bill-detail-module-es5.js.map