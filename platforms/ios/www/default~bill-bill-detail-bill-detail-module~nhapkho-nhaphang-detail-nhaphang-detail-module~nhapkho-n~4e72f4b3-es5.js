(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~bill-bill-detail-bill-detail-module~nhapkho-nhaphang-detail-nhaphang-detail-module~nhapkho-n~4e72f4b3"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppDonvitinhDvtDvtComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppVattuVattuIndexVattuIndexPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppDonvitinhDvtDvtComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppDonvitinhDvtDvtComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DVTComponent", function () {
        return DVTComponent;
      });
      /* harmony import */
      ...
      var DVTComponent = /*#__PURE__*/function () {
        function DVTComponent(navParams, LoadingService, XuatkhoService, popoverController, GlobalService) {
          _classCallCheck(this, DVTComponent);
        ...
        _createClass(DVTComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "getDVT",
          value: function getDVT() {
            var _this = this;

            this.LoadingService.setValue(true);
            this.InOutType = localStorage.getItem("InOutType");
            this.XuatkhoService.DonViTinh(this.MaVT).subscribe(function (response) {
              console.log("36", response);
              _this.listDVT = response; // for (let i = 0; i < this.listDVT.length; i++) {
          ...
          value: function handleDVT(item) {
            this.popoverController.dismiss(item); // this.GlobalService.closeModalSenData(item);
          }
        }]);
      ...
      DVTComponent.ctorParameters = function () {
        return [{
      ...
      DVTComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dvt',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./dvt.component.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/donvitinh/dvt/dvt.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./dvt.component.scss */
        "./src/app/donvitinh/dvt/dvt.component.scss"))["default"]]
      })], DVTComponent);
      /***/
    },
    ...
    /***/
    function srcAppVattuVattuIndexVattuIndexPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppVattuVattuIndexVattuIndexPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VattuIndexPage", function () {
        return VattuIndexPage;
      });
      /* harmony import */
      ...
      var VattuIndexPage = /*#__PURE__*/function () {
        function VattuIndexPage(GlobalService, LoadingService, VattuService, cdr, navParams, currencyPipe, popoverController) {
          _classCallCheck(this, VattuIndexPage);
          ...
          this.countIndex = -1;
          this.listVattu = this.navParams.data.listVattu; // console.log('this.listVattu', this.listVattu);

          this.displayImg = JSON.parse(localStorage.getItem('displayImg') || 'false'); // console.log('this.navParams.data.listVattu ==========', this.navParams.data.listVattu);
          // console.log('this.listVattu ============', this.listVattu);

          if (this.listVattu) {
            this.listDataSearch = this.listVattu;
            this.listExist = this.navParams.data.listItem; // console.log('this.navParams.data.listItem', this.navParams.data.listItem);

            console.log('this.listExist', this.listExist);
            this.countMoney(this.listExist); // console.log('this.listExist', this.listExist);
        ...
        _createClass(VattuIndexPage, [{
          ...
          value: function getSandVT() {
            ...
            for (var i = 0; i < listItem.length; i++) {
              ...
              for (var j = 0; j < this.listExist.length; j++) {
                ...
                if (listItem[i].MaVT == this.listExist[j].MaVT && listItem[i].LoHang == this.listExist[j].LoHang) {
                  ...
                  getVattuTonTai.item = this.listExist[j]; // console.log('aaaaaaaaaaa', getVattuTonTai.index);
                }
              ...
              if (getVattuTonTai.index > -1) {
                ...
                listItem[i].HanDung = getVattuTonTai.item['HanDung']; // console.log('listItem[i].SoLuong', listItem[i].SoLuong);
            ...
            for (var _i = 0; _i <= this.listData.length - 1; _i++) {
              var item = this.listData[_i];
          ...
          value: function getVattu() {
            ...
            this.VattuService.GetListVT(this.sendVattu).subscribe(function (response) {
              _this2.listData = response;
              console.log(_this2.listVattu);
              _this2.countVattu = response.length;
              _this2.listDataSearch = response;

              _this2.LoadingService.setValue(false);
            }, function (error) {
              _this2.LoadingService.setValue(false);
          ...
          value: function getItem(item) {
            ...
            this.listData.find(function (o, i) {
              if (o.VatTuID == item.VatTuID) {
                _this3.listData[i]['checkHover'] = true;
              } else {
                _this3.listData[i]['checkHover'] = false;
              }
            });
          }
        }, {
          key: "handleAdd",
          value: function handleAdd(check, index, item) {
            ...
            if (check == true) {
              ...
              this.listExist = this.listExist.filter(function (x) {
                return x.MaVT !== item.MaVT;
          ...
          key: "formatInput",
          value: function formatInput(item, MaVT, LoHang, index, type, e) {
            // console.log('countIndex', countIndex);
            LoHang = LoHang ? LoHang : ''; // console.log('LoHang', LoHang);

            if (this.page == 'nhapmua') {
              var checkIndex = this.listVattu.findIndex(function (x) {
                return x.MaVT == MaVT;
              });
              var checkIndexExit = this.listExist.findIndex(function (x) {
                return x.MaVT == MaVT;
              });
            } else {
              var checkIndex = this.listVattu.findIndex(function (x) {
                return x.MaVT == MaVT && x.LoHang == LoHang;
              });
              var checkIndexExit = this.listExist.findIndex(function (x) {
                return x.MaVT == MaVT && x.LoHang == LoHang;
              });
            ...
            this.listVattu[checkIndex][item] = convNumber; // console.log('this.listVattu[checkIndex][item]', this.listVattu[checkIndex][item]);
          ...
          key: "setItem",
          value: function setItem(item, MaVT, e) {
            var checkIndexExit = this.listExist.findIndex(function (x) {
              return x.MaVT === MaVT;
            });
          ...
          value: function deleteSearch() {
            ...
            this.pageInfo.page = 1; // this.listData = this.listDataSearch;
                      ...
                      popover.onDidDismiss().then(function (dataReturned) {
                        ...
                        if (dataReturned.data) {
                          ...
                          for (var i = 0; i < _this4.listData.length; i++) {
                            if (_this4.listData[i].MaVT == MaVT) {
                              _this4.listData[i].DVT = dataReturned.data.DVT;
                              _this4.listData[i].DonGia = dataReturned.data.GiaMua; // this.listData[i].DonGia = new Intl.NumberFormat().format(dataReturned.data.GiaMua).replace(/\./g, ',');
                            }
                          }

                          for (var _i2 = 0; _i2 < _this4.listExist.length; _i2++) {
                            if (_this4.listExist[_i2].MaVT == MaVT) {
                              _this4.listExist[_i2].DVT = dataReturned.data.DVT;
                              _this4.listExist[_i2].DonGia = dataReturned.data.GiaMua;
                            }
                          }

                          var checkIndexExit = _this4.listExist.findIndex(function (x) {
                            return x.MaVT === MaVT;
                          });

                          _this4.listExist[checkIndexExit].ThanhTien = _this4.listExist[checkIndexExit].SoLuong * _this4.listExist[checkIndexExit].DonGia;
                          _this4.listVattu[index].ThanhTien = new Intl.NumberFormat().format(_this4.listExist[checkIndexExit].ThanhTien).replace(/\./g, ',');

                          _this4.getTongTien(checkIndexExit); // this.listExist.forEach(function (a) {
          ...
          value: function closeModal() {
            this.GlobalService.closeModal(); // const content = document.querySelector('ion-content');
      ...
      VattuIndexPage.ctorParameters = function () {
        return [{
      ...
      VattuIndexPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-vattu-index',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./vattu-index.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/vattu/vattu-index/vattu-index.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./vattu-index.page.scss */
        "./src/app/vattu/vattu-index/vattu-index.page.scss"))["default"]]
      })], VattuIndexPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=default~bill-bill-detail-bill-detail-module~nhapkho-nhaphang-detail-nhaphang-detail-module~nhapkho-n~4e72f4b3-es5.js.map