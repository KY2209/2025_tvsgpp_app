(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["donvi-donvi-create-donvi-create-module"], {
    /***/
    "./src/app/donvi/donvi-create/donvi-create-routing.module.ts":
    /*!*******************************************************************!*\
      !*** ./src/app/donvi/donvi-create/donvi-create-routing.module.ts ***!
      \*******************************************************************/

    /*! exports provided: DonviCreatePageRoutingModule */

    /***/
    function srcAppDonviDonviCreateDonviCreateRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DonviCreatePageRoutingModule", function () {
        return DonviCreatePageRoutingModule;
      });
      /* harmony import */
      ...
      var _donvi_create_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./donvi-create.page */
      "./src/app/donvi/donvi-create/donvi-create.page.ts");

      var routes = [{
        path: '',
        component: _donvi_create_page__WEBPACK_IMPORTED_MODULE_3__["DonviCreatePage"]
      }];

      var DonviCreatePageRoutingModule = function DonviCreatePageRoutingModule() {
        _classCallCheck(this, DonviCreatePageRoutingModule);
      };

      DonviCreatePageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    "./src/app/donvi/donvi-create/donvi-create.module.ts":
    /*!***********************************************************!*\
      !*** ./src/app/donvi/donvi-create/donvi-create.module.ts ***!
      \***********************************************************/

    /*! exports provided: DonviCreatePageModule */

    /***/
    function srcAppDonviDonviCreateDonviCreateModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DonviCreatePageModule", function () {
        return DonviCreatePageModule;
      });
      /* harmony import */
      ...
      var _donvi_create_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./donvi-create-routing.module */
      "./src/app/donvi/donvi-create/donvi-create-routing.module.ts");
      /* harmony import */


      var _donvi_create_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./donvi-create.page */
      "./src/app/donvi/donvi-create/donvi-create.page.ts");

      var DonviCreatePageModule = function DonviCreatePageModule() {
        _classCallCheck(this, DonviCreatePageModule);
      };

      DonviCreatePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _donvi_create_routing_module__WEBPACK_IMPORTED_MODULE_5__["DonviCreatePageRoutingModule"]],
        declarations: [_donvi_create_page__WEBPACK_IMPORTED_MODULE_6__["DonviCreatePage"]]
      })], DonviCreatePageModule);
      /***/
    },
...
//# sourceMappingURL=donvi-donvi-create-donvi-create-module-es5.js.map