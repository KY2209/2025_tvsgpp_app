...
/* harmony import */ var src_app_service_xuatkho_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/service/xuatkho.service */ "./src/app/service/xuatkho.service.ts");
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helper */ "./src/app/share/helper.ts");




let PrintBillComponent = class PrintBillComponent {
    constructor(XuatkhoService, cdr, convertHelper) {
    ...
    getChungTuDetail() {
        this.XuatkhoService.xuatHangDetail(this.ChungTuInfo).subscribe((response) => {
    ...
    countMoney() {
        ...
        this.sumVAT = 0;
        this.sumChietKhau = 0;
        for (let i = 0; i < ((_a = this.itemDetail) === null || _a === void 0 ? void 0 : _a.ChiTietHang.length); i++) {
...
PrintBillComponent.ctorParameters = () => [
...
PrintBillComponent.propDecorators = {
    ChungTuInfo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
    data: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }]
};
PrintBillComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-print-bill',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./print-bill.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/share/print-bill/print-bill.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./print-bill.component.scss */ "./src/app/share/print-bill/print-bill.component.scss")).default]
    })
], PrintBillComponent);
...
//# sourceMappingURL=default~bill-bill-list-bill-list-module~xuatkho-xuathang-addnew-xuathang-addnew-module~xuatkho-xuath~971bda02-es2015.js.map