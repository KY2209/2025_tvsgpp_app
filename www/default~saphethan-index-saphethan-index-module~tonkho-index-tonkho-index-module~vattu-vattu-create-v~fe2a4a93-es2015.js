...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VattuCreatePage", function() { return VattuCreatePage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var src_app_share_group_product_group_product_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/share/group-product/group-product.page */ "./src/app/share/group-product/group-product.page.ts");
/* harmony import */ var src_app_share_hang_san_xuat_hang_san_xuat_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/share/hang-san-xuat/hang-san-xuat.page */ "./src/app/share/hang-san-xuat/hang-san-xuat.page.ts");
/* harmony import */ var src_app_share_helper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/share/helper */ "./src/app/share/helper.ts");
/* harmony import */ var src_app_share_nuoc_san_xuat_nuoc_san_xuat_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/share/nuoc-san-xuat/nuoc-san-xuat.page */ "./src/app/share/nuoc-san-xuat/nuoc-san-xuat.page.ts");
/* harmony import */ var src_app_donvitinh_dvt_create_dvt_create_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/donvitinh/dvt-create/dvt-create.page */ "./src/app/donvitinh/dvt-create/dvt-create.page.ts");
/* harmony import */ var src_app_service_AlertService__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/service/AlertService */ "./src/app/service/AlertService.ts");
...
/* harmony import */ var _vattu_quocgia_vattu_quocgia_page__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../vattu-quocgia/vattu-quocgia.page */ "./src/app/vattu/vattu-quocgia/vattu-quocgia.page.ts");
...
let VattuCreatePage = class VattuCreatePage {
    constructor(GlobalService, modalController, currencyPipe, LoadingService, actionSheetController, VattuService, navParams, AlertService, popoverController, convertHelper, ToastService) {
        this.GlobalService = GlobalService;
    ...
    vattuDetail() {
        ...
        this.VattuService.detailVattu(this.vatTuId).subscribe((response) => {
            this.sendItem = {
    ...
    onChange(event) {
        ...
        if (file) {
            this.convertHelper.convertFileToBase64(file).then((base64) => {
    ...
    handleProduct() {
        ...
        this.AlertService.presentAlert(`Xác nhận lưu vật tư?`).then(res => {
            if (res == 'true') {
                this.LoadingService.setValue(true);
                this.VattuService.createVattu(this.sendItem).subscribe((response) => {
    ...
    removeDVT(DonViTinhID) {
        this.VattuService.deleteDVT(DonViTinhID).subscribe((response) => {
        }, (error) => {
            setTimeout(() => {
                console.log('error', error);
            }, 1000);
...
VattuCreatePage.ctorParameters = () => [
    { type: src_app_service_global_service__WEBPACK_IMPORTED_MODULE_4__["GlobalService"] },
...
VattuCreatePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-vattu-create',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./vattu-create.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/vattu/vattu-create/vattu-create.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./vattu-create.page.scss */ "./src/app/vattu/vattu-create/vattu-create.page.scss")).default]
    })
], VattuCreatePage);
...
//# sourceMappingURL=default~saphethan-index-saphethan-index-module~tonkho-index-tonkho-index-module~vattu-vattu-create-v~fe2a4a93-es2015.js.map