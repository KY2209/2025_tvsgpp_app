(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["notifications-list-notifications-list-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppNotificationsListNotificationsListPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppNotificationsListNotificationsListRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NotificationsListPageRoutingModule", function () {
        return NotificationsListPageRoutingModule;
      });
      /* harmony import */
      ...
      var _notifications_list_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var NotificationsListPageRoutingModule = function NotificationsListPageRoutingModule() {
        _classCallCheck(this, NotificationsListPageRoutingModule);
      };

      NotificationsListPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppNotificationsListNotificationsListModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NotificationsListPageModule", function () {
      ...
      var _notifications_list_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./notifications-list-routing.module */
      "./src/app/notifications-list/notifications-list-routing.module.ts");
      /* harmony import */


      var _notifications_list_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./notifications-list.page */
      "./src/app/notifications-list/notifications-list.page.ts");

      var NotificationsListPageModule = function NotificationsListPageModule() {
        _classCallCheck(this, NotificationsListPageModule);
      };

      NotificationsListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _notifications_list_routing_module__WEBPACK_IMPORTED_MODULE_5__["NotificationsListPageRoutingModule"]],
    ...
    /***/
    function srcAppNotificationsListNotificationsListPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppNotificationsListNotificationsListPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NotificationsListPage", function () {
      ...
      var NotificationsListPage = /*#__PURE__*/function () {
        function NotificationsListPage(navCtrl, router, loadingController, toastController, Function, modalController, navController, platform) {
          _classCallCheck(this, NotificationsListPage);
        ...
        _createClass(NotificationsListPage, [{
          key: "getThongBaoGPP",
          value: function getThongBaoGPP() {
            var _this = this;

            var data = this.Function.getThongBao();
            data.subscribe(function (rs) {
              console.log(rs);
              _this.lstThongBao = rs;
              _this.lstThongBaoAll = _this.lstThongBao;

              for (var i = 0; i <= _this.lstThongBao.length - 1; i++) {
                var item = _this.lstThongBao[i];
          ...
          value: function filterInfo(pid) {
            ...
            if (val && val.trim() != '') {
              ...
              this.lstThongBao = this.lstThongBao.filter(function (info) {
          ...
          key: "viewDetail",
          value: function viewDetail(ChungTuID) {
            var item = {
              "nftID": ChungTuID
            };
      ...
      NotificationsListPage.ctorParameters = function () {
        return [{
      ...
      NotificationsListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-notifications-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./notifications-list.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/notifications-list/notifications-list.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./notifications-list.page.scss */
        "./src/app/notifications-list/notifications-list.page.scss"))["default"]]
      })], NotificationsListPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=notifications-list-notifications-list-module-es5.js.map