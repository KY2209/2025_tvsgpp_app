(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhapkho-nhaphang-update-nhaphang-update-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppNhapkhoNhaphangUpdateNhaphangUpdatePageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppNhapkhoNhaphangUpdateNhaphangUpdateRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NhaphangUpdatePageRoutingModule", function () {
        return NhaphangUpdatePageRoutingModule;
      });
      /* harmony import */
      ...
      var _nhaphang_update_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./nhaphang-update.page */
      ...
      var NhaphangUpdatePageRoutingModule = function NhaphangUpdatePageRoutingModule() {
        _classCallCheck(this, NhaphangUpdatePageRoutingModule);
      };

      NhaphangUpdatePageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppNhapkhoNhaphangUpdateNhaphangUpdateModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NhaphangUpdatePageModule", function () {
        return NhaphangUpdatePageModule;
      });
      /* harmony import */
      ...
      var _nhaphang_update_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./nhaphang-update-routing.module */
      "./src/app/nhapkho/nhaphang-update/nhaphang-update-routing.module.ts");
      /* harmony import */


      var _nhaphang_update_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./nhaphang-update.page */
      "./src/app/nhapkho/nhaphang-update/nhaphang-update.page.ts");
      /* harmony import */


      var _xuatkho_xuathang_item_xuathang_item_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../xuatkho/xuathang-item/xuathang-item.component */
      "./src/app/xuatkho/xuathang-item/xuathang-item.component.ts");

      var NhaphangUpdatePageModule = function NhaphangUpdatePageModule() {
        _classCallCheck(this, NhaphangUpdatePageModule);
      };

      NhaphangUpdatePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _nhaphang_update_routing_module__WEBPACK_IMPORTED_MODULE_5__["NhaphangUpdatePageRoutingModule"]],
    ...
    /***/
    function srcAppNhapkhoNhaphangUpdateNhaphangUpdatePageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppNhapkhoNhaphangUpdateNhaphangUpdatePageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NhaphangUpdatePage", function () {
        return NhaphangUpdatePage;
      });
      /* harmony import */
      ...
      var NhaphangUpdatePage = /*#__PURE__*/function () {
        function NhaphangUpdatePage(modalController, // private navParams: NavParams,
        GlobalService, XuatkhoService, VattuService, LoadingService, route, ToastService, router, navController, actionSheetController, KhoService, UnitService, cdr, FunctionService, AlertService, printer) {
          _classCallCheck(this, NhaphangUpdatePage);
        ...
        _createClass(NhaphangUpdatePage, [{
          key: "ionViewDidEnter",
          value: function ionViewDidEnter() {
            ...
            this.route.queryParams.subscribe(function (params) {
              ...
              if (params.isCreate == 'true') {
                ...
                _this.sendItem.SoCT = "NM".concat(_this.sendItem.ChungTuID);
              } else {
                _this.title = "Sửa";
          ...
          value: function getKho() {
            ...
            this.KhoService.getKho().subscribe(function (response) {
              ...
              if (_this2.isCreate == 'true') {
                ...
                _this2.displayItem.KhoNhap = response[0].TenKho;
                _this2.sendItem.KhoNhap = response[0].MaKho;
              }
          ...
          value: function resetItem() {
            ...
            this.sendItem.SoCT = "NM".concat(this.sendItem.ChungTuID);
            setTimeout(function () {
          ...
          value: function getChungTuDetail() {
            ...
            this.XuatkhoService.xuatHangDetail(this.chungchi).subscribe(function (response) {
              ...
              _this7.makho = response[0].KhoNhap;
              _this7.displayItem.KhoNhap = response[0]._TenKhoNhap;
              _this7.displayItem.DVNhap = response[0]._TenDVNhap;
              ...
              _this7.sendItem.DVNhap = response[0].DVNhap;
              _this7.sendItem.KhoNhap = response[0].KhoNhap;
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (dataReturned) {
                        ...
                        if (dataReturned.data) {
                          _this8.sendItem.DVNhap = dataReturned.data.MaDV;
                          _this8.displayItem.DVNhap = dataReturned.data.TenDV;
                        }
                      });
                      _context.next = 6;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (dataReturned) {
                        if (dataReturned.data) {
                          _this9.makho = dataReturned.data.MaKho;
                          _this9.sendItem.KhoNhap = dataReturned.data.MaKho;
                          _this9.displayItem.KhoNhap = dataReturned.data.TenKho;
          ...
          value: function submit() {
            ...
            if (this.isCreate == 'true') {
              ...
              this.AlertService.presentAlert("B\u1EA1n c\xF3 ch\u1EAFc mu\u1ED1n s\u1EEDa phi\u1EBFu?").then(function (res) {
                if (res == 'true') {
                  _this10.updateImport();
                }
              });
            }
          }
          ...
          value: function confirmCreate() {
            ...
            this.AlertService.presentAlert("B\u1EA1n c\xF3 ch\u1EAFc mu\u1ED1n th\xEAm m\u1EDBi?").then(function (res) {
              if (res == 'true') {
                _this11.createImport();
              }
            });
          }
        }, {
          ...
          value: function createImport() {
            ...
            this.XuatkhoService.createXuatHang(this.sendItem).subscribe(function (response) {
              if (response.code == 0) {
                _this12.ToastService.successToast(response.message);

                _this12.submitForm = 0;

                _this12.resetItem();
              } else {
                _this12.ToastService.errorToast(response.message);
              }

              console.log('response', response); // this.LoadingService.setValue(false);

              _this12.LoadingService.setValue(false);
            }, function (error) {
              _this12.LoadingService.setValue(false);
          ...
          value: function updateImport() {
            ...
            this.XuatkhoService.updateXuatHang(this.sendItem).subscribe(function (response) {
              ...
              if (response.code == 0) {
                _this13.ToastService.successToast(response.message);

                _this13.submitForm = 0;
              } else {
                _this13.ToastService.errorToast(response.message);
              } // this.LoadingService.setValue(false);


              _this13.LoadingService.setValue(false);
            }, function (error) {
              _this13.LoadingService.setValue(false);
          ...
          value: function openPrint() {
            ...
            this.printer.isAvailable().then(function (onsuccess) {
              _this14.printer.print(divContent).then(function (value) {
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this15.send_httt = "TM";
                            _this15.display_httt = "Tiền mặt";
                          }
                        }, {
                          text: 'Chuyển khoản',
                          icon: 'qr-code-outline',
                          handler: function handler() {
                            _this15.send_httt = "CK";
                            _this15.display_httt = "Chuyển khoản";
                          }
                        }]
                      });
      ...
      NhaphangUpdatePage.ctorParameters = function () {
        return [{
      ...
      NhaphangUpdatePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-nhaphang-update',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./nhaphang-update.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/nhapkho/nhaphang-update/nhaphang-update.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./nhaphang-update.page.scss */
        "./src/app/nhapkho/nhaphang-update/nhaphang-update.page.scss"))["default"]]
      })], NhaphangUpdatePage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=nhapkho-nhaphang-update-nhaphang-update-module-es5.js.map